...
esp_err_t wifi_config_sta(void) {
    ...
    if (ret == ESP_ERR_NVS_NO_FREE_PAGES || ret == ESP_ERR_NVS_NEW_VERSION_FOUND) {
        ESP_RETURN_ON_ERROR(nvs_flash_erase(), TAG, "nvs_flash_erease() fail");
        ESP_RETURN_ON_ERROR(nvs_flash_init(), TAG, "nvs_flash_init() fail");
    }
    ...
    ESP_RETURN_ON_ERROR(esp_event_handler_instance_register(WIFI_EVENT,
                                                        ...
                                                        &event_handler,
                                                        NULL,
                                                        &instance_any_id), TAG, "esp_event_handler_instance_register");
    ESP_RETURN_ON_ERROR(esp_event_handler_instance_register(IP_EVENT,
                                                        IP_EVENT_STA_GOT_IP,
                                                        &event_handler,
                                                        NULL,
                                                        &instance_got_ip), TAG, "esp_event_handler_instance_register");
